...
Here's a plotting example for graphing out state values on grid world type environments like frozen lake.  See bettermdptools/examples for more plots and grid search starter code.    
